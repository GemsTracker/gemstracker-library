 ...
 */
class IndexAction extends \Gems\Controller\Action
{
    /**
     ...
     *
     * @param \Gems\User\Form\LoginForm $form
     * @deprecated since version 1.8.4 no longer in use with 2FA login
     */
    protected function displayLoginForm(\Gems\User\Form\LoginForm $form)
    {
     ...
     *
     * @param \Gems\Form\AutoLoadFormAbstract $form Rset password or reset request form
     * @param mixed $errors
     */
    protected function displayResetForm(\Gems\Form\AutoLoadFormAbstract $form, $errors)
    {
        if ($form instanceof \Gems\User\Validate\GetUserInterface) {
            $user = $form->getUser();
        }

        if ($form instanceof \Gems\User\Form\ResetRequestForm) {
        ...
        } elseif ($form instanceof \Gems\User\Form\ChangePasswordForm) {
        ...
        $formContainer = \MUtil\Html::create('div', array('class' => 'resetPassword'), $form);
    ...
    /**
     * Dummy: always rerouted by \Gems\Escort
     */
    ...
    public function loginAction()
    {
        ...
        if ($form->wasSubmitted()) {
            if ($form->isValid($request->getPost(), false)) {
                 ...
                 */
                \Gems\Cookies::setLocale($user->getLocale(), $this->basepath->getBasePath());
                ...
                $errors = \MUtil\Ra::flatten($form->getMessages());
    ...
    public function resetpasswordAction()
    {
        ...
        if ($key = $this->_getParam('key')) {
            ...
            // \MUtil\EchoOut\EchoOut::track($user->hasValidResetKey(), $user->getLoginName(), $user->hasPassword(), $user->isActive());
        ...
        if ($request->isPost() && $form->isValid($request->getPost(), false)) {
            ...
            if ($form instanceof \Gems\User\Form\ResetRequestForm) {
                ...
                $validator = new \Gems\User\Validate\ResetRequestValidator($form, $this->translate);
     ...
     * @param \Gems\User\User $user
     */
    protected function setCurrentOrganizationTo(\Gems\User\User $user)
    {
