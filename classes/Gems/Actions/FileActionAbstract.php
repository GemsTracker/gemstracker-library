...
abstract class FileActionAbstract extends \Gems\Controller\ModelSnippetActionAbstract
{
     ...
     * @var mixed String or array of snippets name
     */
    protected $importSnippets = 'Import\\FileImportSnippet';
    ...
    {
        return sprintf($this->_('Edit file %s'), \MUtil\Model\Iterator\FolderModelIterator::fromUrlSaveToName($this->_getIdParam()));
    }
    ...
    {
        return sprintf($this->_('Showing file %s'), \MUtil\Model\Iterator\FolderModelIterator::fromUrlSaveToName($this->_getIdParam()));
    }
