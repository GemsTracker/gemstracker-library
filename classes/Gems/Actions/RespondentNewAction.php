 ...
 */
abstract class RespondentNewAction extends \Gems\Actions\RespondentChildActionAbstract
{
    /**
     *
     * @var \Gems\AccessLog
    ...
    public function getSearchDefaults()
    {
        if (! isset($this->defaultSearchData[\MUtil\Model::REQUEST_ID2])) {
            if ($this->currentUser->hasPrivilege('pr.respondent.multiorg') &&
                ...
                $this->defaultSearchData[\MUtil\Model::REQUEST_ID2] = $this->currentOrganization->getId();
            }
        }
    ...
    {
        $orgId     = $this->_getParam(\MUtil\Model::REQUEST_ID2);
