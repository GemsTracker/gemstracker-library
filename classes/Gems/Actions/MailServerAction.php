 ...
 */
class MailServerAction extends \Gems\Controller\ModelSnippetActionAbstract
{
    /**
    ...
    {
        $model = new \MUtil\Model\TableModel('gems__mail_servers');

        \Gems\Model::setChangeFieldsByPrefix($model, 'gms');
        ...
        $model->set('gms_ssl',
                ...
                'required', false,
                'multiOptions', array(
                    \Gems\Mail::MAIL_NO_ENCRYPT => $this->_('None'),
                    \Gems\Mail::MAIL_SSL => $this->_('SSL'),
                    \Gems\Mail::MAIL_TLS => $this->_('TLS')));
        $model->set('gms_port',
                'label', $this->_('Port'),
                'required', true,
        ...
        if ($detailed) {
            ...
            $type = new \Gems\Model\Type\EncryptedField($this->project, true);
