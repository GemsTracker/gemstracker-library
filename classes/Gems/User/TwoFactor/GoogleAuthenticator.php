...
class GoogleAuthenticator extends \MUtil_Translate_TranslateableAbstract implements TwoFactorAuthenticatorInterface
{
    /**
     *
     * @var int
    ...
    public function addSetupFormElements(\Zend_Form $form, \Gems_User_User $user, array &$formData)
    {
        ...
        if ($user->canSaveTwoFactorKey()) {
            ...
            $keyElement->addFilter('StringToUpper')
                    ->addValidator('Base32')
                    ->addValidator('StringLength', true, ['min' => 16, 'max' => 16]);
    ...
    {
        return $this->verifyCode($secret, $code, 2);
    }
