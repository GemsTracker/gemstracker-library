 ...
 */
class LocationField extends FieldAbstract
{
    /**
    ...
    protected function addModelSettings(array &$settings)
    {
        ...
        $settings['multiOptions'] = $empty + $this->loader->getAgenda()->getLocations();
    }
    ...
    public function getDataModelDependyChanges(array $context, $new)
    {
        ...
        $output['multiOptions'] = $empty + $agenda->getLocations($context['gr2t_id_organization']);
