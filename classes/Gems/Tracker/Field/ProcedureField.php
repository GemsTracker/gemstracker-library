 ...
 * @copyright  Copyright (c) 2015 Erasmus MC
 * @license    New BSD License
 * @since      Class available since version 1.6.5 4-mrt-2015 11:44:35
 */
class ProcedureField extends FieldAbstract
{
    /**
    ...
    protected function addModelSettings(array &$settings)
    {
        ...
        $settings['multiOptions'] = $empty + $this->loader->getAgenda()->getProcedures();
    }
    ...
    public function getDataModelDependyChanges(array $context, $new)
    {
        ...
        $output['multiOptions'] = $empty + $agenda->getProcedures($context['gr2t_id_organization']);
