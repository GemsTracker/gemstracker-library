...
INSERT INTO gems__comm_templates (gct_id_template, gct_name, gct_target, gct_code, gct_changed, gct_changed_by, gct_created, gct_created_by)
    VALUES
    (11, 'Questions for your treatment at {organization}', 'token',,CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1),
    (12, 'Reminder: your treatment at {organization}', 'token',,CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1),
    (13, 'Questions for your treatment at {organization} with unsubscribe', 'token',,CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1),
    (14, 'Reminder: your treatment at {organization} with unsubscribe', 'token',,CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1),
    (15, 'Questions for treatment of {relation_about} at {organization}', 'token',,CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1),
    (16, 'Reminder: treatment of {relation_about} at {organization}', 'token',,CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1),
