    ...
    public function testGetTableInfoEmptyDb()
    {
        ...
        $expected = [
            'test__other_table' => [
                ...
                'data' => '',
                'sql' => '',
                'lastChanged' => \DateTimeImmutable::createFromFormat('U', (string) filemtime(__DIR__ . '/../../TestData/Db/TableRepository/test__other_table.100.sql')),
            ...
            'test__table' => [
                ...
                'data' => $sql2,
                'sql' => $sql2,
                'lastChanged' => \DateTimeImmutable::createFromFormat('U', (string) filemtime(__DIR__ . '/../../TestData/Db/TableRepository/test__table.sql')),
