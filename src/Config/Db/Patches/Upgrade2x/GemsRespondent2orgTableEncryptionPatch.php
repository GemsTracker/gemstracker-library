...
class GemsRespondent2orgTableEncryptionPatch extends PatchAbstract
{
    ...
    {
        return 'Encrypt the respondent2org table if default encryption is enabled';
    }

    public function getOrder(): int
    {
        return 20231204990001;
    }
    ...
    public function up(): array
    {
        ...
        foreach ($this->gems_tables as $table) {
            // Only encrypt the respondent2org table.
