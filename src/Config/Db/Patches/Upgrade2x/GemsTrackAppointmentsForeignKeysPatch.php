...
class GemsTrackAppointmentsForeignKeysPatch extends PatchAbstract
{
    private string $table = 'gems__track_appointments';

    private array $foreignKeys = [
        [ 'gtap_id_track', 'gems__tracks', 'gtr_id_track' ],
        [ 'gtap_filter_id', 'gems__appointment_filters', 'gaf_id' ],
    ];
