...
class GemsTokensTableEncryptionPatch extends PatchAbstract
{
    ...
    {
        return 'Encrypt the tokens table if default encryption is enabled';
    }

    public function getOrder(): int
    {
        return 20231204990003;
    }
