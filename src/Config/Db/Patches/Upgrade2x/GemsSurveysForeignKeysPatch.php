...
class GemsSurveysForeignKeysPatch extends PatchAbstract
{
    private string $table = 'gems__surveys';

    private array $foreignKeys = [
        [ 'gsu_id_source', 'gems__sources', 'gso_id_source' ],
        [ 'gsu_id_primary_group', 'gems__groups', 'ggp_id_group' ],
        [ 'gsu_mail_code', 'gems__mail_codes', 'gmc_id' ],
    ];
