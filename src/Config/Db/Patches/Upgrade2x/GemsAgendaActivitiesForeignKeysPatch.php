...
class GemsAgendaActivitiesForeignKeysPatch extends PatchAbstract
{
    private string $table = 'gems__agenda_activities';

    private array $foreignKeys = [
        [ 'gaa_id_organization', 'gems__organizations', 'gor_id_organization' ],
    ];
