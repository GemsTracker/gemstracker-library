...
class GemsAgendaProceduresForeignKeysPatch extends PatchAbstract
{
    private string $table = 'gems__agenda_procedures';

    private array $foreignKeys = [
        [ 'gapr_id_organization', 'gems__organizations', 'gor_id_organization' ],
    ];
