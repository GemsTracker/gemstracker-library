...
class GemsLogActivityTableEncryptionPatch extends PatchAbstract
{
    ...
    {
        return 'Encrypt log_activity table if default encryption is enabled';
    }

    public function getOrder(): int
    {
        return 20231204990005;
    }
    ...
    public function up(): array
    {
        ...
        foreach ($this->gems_tables as $table) {
            // Only encrypt the log_activity table.
