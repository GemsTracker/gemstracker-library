...
class GemsUserLoginAttemptsForeignKeysPatch extends PatchAbstract
{
    private string $table = 'gems__user_login_attempts';

    private array $foreignKeys = [
        [ 'gula_id_organization', 'gems__organizations', 'gor_id_organization' ],
    ];
    ...
    {
        $statements = [
            'ALTER TABLE gems__user_login_attempts MODIFY COLUMN gula_id_organization bigint unsigned NOT NULL',
        ];
