...
class GemsPasswordResetAttemptsForeignKeysPatch extends PatchAbstract
{
    private string $table = 'gems__password_reset_attempts';

    private array $foreignKeys = [
        [ 'gpra_id_organization', 'gems__organizations', 'gor_id_organization' ],
    ];
