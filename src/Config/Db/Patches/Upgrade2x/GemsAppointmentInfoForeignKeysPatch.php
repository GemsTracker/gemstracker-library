...
class GemsAppointmentInfoForeignKeysPatch extends PatchAbstract
{
    private string $table = 'gems__appointment_info';

    private array $foreignKeys = [
        [ 'gai_id_filter', 'gems__appointment_filters', 'gaf_id' ],
    ];
