 ...
 */
class HourKeyAes256 extends TimeKeyAes256Abstract
{
    /**
    ...
    {
        return sprintf($this->translator->_('Hour valid key encrypted with %s, iv length %d'), $this->encryptionAlgorithm, $this->getIvLength());
    }
}
