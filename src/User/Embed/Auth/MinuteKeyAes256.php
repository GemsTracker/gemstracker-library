 ...
 */
class MinuteKeyAes256 extends TimeKeyAes256Abstract
{
    /**
    ...
    {
        return sprintf($this->translator->_('Minute valid key encrypted with %s, iv length %d'), $this->encryptionAlgorithm, $this->getIvLength());
    }
}
