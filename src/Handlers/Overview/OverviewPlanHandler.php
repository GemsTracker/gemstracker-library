...
class OverviewPlanHandler extends TokenSearchHandlerAbstract
{
    ...
    {
        Tracker\Model\TokenModel::$useTokenModel = false;
        return parent::createModel($detailed, $action); // TODO: Change the autogenerated stub
    }
    ...
    public function getSearchFilter(bool $useRequest = true): array
    {
        ...
        foreach ($realFilter as $key => $value) {
            if (! (is_integer($key) || $metaModel->has($key))) {
