...
class StaffRepository
{
    ...
    )
    {
        ...
        $metaModel = $staffModel->getMetaModel();

        $metaModel->addTransformer(new ValidateFieldsTransformer($staffModel, $this->overloader, $this->currentUserRepository->getCurrentUserId()));
