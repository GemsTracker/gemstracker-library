...
CREATE TABLE if not exists gems__comm_templates (
      ...
      gct_name        varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,
      gct_target      varchar(32) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,
      gct_code        varchar(64)  CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
