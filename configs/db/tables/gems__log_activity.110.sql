...
CREATE TABLE if not exists gems__log_activity (
        ...
        gla_role            varchar(20) character set 'utf8mb4' collate 'utf8mb4_general_ci' not null,

        gla_changed         boolean not null default 0,
        gla_message         text character set 'utf8mb4' collate 'utf8mb4_general_ci' null default null,
        gla_data            text character set 'utf8mb4' collate 'utf8mb4_general_ci' null default null,
        gla_method          varchar(10) character set 'utf8mb4' collate 'utf8mb4_general_ci' not null,
        gla_remote_ip       varchar(64) character set 'utf8mb4' collate 'utf8mb4_general_ci' not null,
