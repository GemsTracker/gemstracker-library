...
CREATE TABLE if not exists gems__agenda_procedures (
        ...
        gapr_name            varchar(250) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci',

        gapr_id_organization bigint unsigned null references gems__organizations (gor_id_organization),

        gapr_name_for_resp   varchar(50) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci',
        gapr_match_to        varchar(250) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci',
        gapr_code            varchar(40) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci',
        ...
        gapr_created         timestamp not null default current_timestamp,
