...
CREATE TABLE if not exists gems__episodes_of_care (
        ...
        gec_source                  varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null default 'manual',
        gec_id_in_source            varchar(40) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null default null,
        gec_manual_edit             boolean not null default 0,

        gec_status                  varchar(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null default 'A',
        ...
        gec_subject                 varchar(250) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null default null,
        gec_comment                 text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null default null,

        gec_diagnosis               varchar(250) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null default null,
        gec_diagnosis_data          text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null default null,
        gec_extra_data              text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null default null,
        ...
        gec_created                 timestamp not null default current_timestamp,
