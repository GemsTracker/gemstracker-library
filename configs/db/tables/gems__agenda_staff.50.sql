...
CREATE TABLE if not exists gems__agenda_staff (
        ...
        gas_name            varchar(250) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci',
        gas_function        varchar(50) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci',
        ...
        gas_match_to        varchar(250) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci',

        gas_source          varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci' not null default 'manual',
        gas_id_in_source    varchar(40) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci' null default null,
