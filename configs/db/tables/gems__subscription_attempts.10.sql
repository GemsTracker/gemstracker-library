...
CREATE TABLE if not exists gems__subscription_attempts (
        ...
        gsa_type_attempt    varchar(16) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
        gsa_ip_address      varchar(64) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
