...
CREATE TABLE if not exists gems__track_fields (
        ...
        gtf_id_track            bigint unsigned not null references gems__tracks (gtr_id_track),
        ...
        gtf_calculate_using     varchar(50) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci',

        gtf_field_type          varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
