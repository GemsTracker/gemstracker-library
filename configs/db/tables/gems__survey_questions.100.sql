...
CREATE TABLE if not exists gems__survey_questions (
        ...
        gsq_name            varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,

        gsq_name_parent     varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci',
        gsq_order           int unsigned not null default 10,
        gsq_type            smallint unsigned not null default 1,
        gsq_class           varchar(50) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci',
        gsq_group           varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci',

        gsq_label           text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci',
        gsq_description     text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci',
