...
CREATE TABLE if not exists gems__survey_questions (
        ...
        gsq_name            varchar(100) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' not null,

        gsq_name_parent     varchar(100) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci',
        ...
        gsq_label           varchar(100) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci',
        gsq_description     varchar(200) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci',
