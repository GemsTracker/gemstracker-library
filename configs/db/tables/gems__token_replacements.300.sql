...
CREATE TABLE if not exists gems__token_replacements (
        gtrp_id_token_new           varchar(9) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,
        gtrp_id_token_old           varchar(9) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,
