...
CREATE TABLE `gems__translations` (
      ...
      gtrs_table            varchar(128) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NOT NULL,
      gtrs_field            varchar(128) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NOT NULL,
      gtrs_keys             varchar(128) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NOT NULL,
      gtrs_iso_lang         varchar(6) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NOT NULL,
      gtrs_translation      text CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL,
