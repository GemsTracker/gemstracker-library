...
CREATE TABLE if not exists gems__migration_logs (
    ...
    gml_version         varchar(30) CHARACTER SET 'utf8mb4' COLLATE utf8mb4_general_ci not null,
    gml_module          varchar(30) CHARACTER SET 'utf8mb4' COLLATE utf8mb4_general_ci not null,
    ...
    gml_comment         text CHARACTER SET 'utf8mb4' COLLATE utf8mb4_general_ci null,
