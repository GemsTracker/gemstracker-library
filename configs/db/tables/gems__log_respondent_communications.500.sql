...
CREATE TABLE if not exists gems__log_respondent_communications (
        ...
        grco_id_token     varchar(9) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci' null references gems__tokens (gto_id_token),

        grco_method       varchar(12) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci' not null,
        grco_topic        varchar(120) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci' not null,
        grco_address      varchar(120) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci' null,
        grco_sender       varchar(120) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci' null,
        grco_comments     varchar(120) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci' null,
