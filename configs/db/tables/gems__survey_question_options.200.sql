...
CREATE TABLE if not exists gems__survey_question_options (
        ...
        gsqo_name           varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,
        -- Order is key as you never now what is in the key used by the providing system
        gsqo_order          int unsigned not null default 0,

        gsqo_key            varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci',
        gsqo_label          varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci',
        ...
        gsqo_created        timestamp not null default current_timestamp,
