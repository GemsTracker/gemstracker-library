...
CREATE TABLE if not exists gems__radius_config (
        ...
        grcfg_ip                varchar(39) CHARACTER SET 'utf8mb4' collate utf8mb4_general_ci default NULL,
        grcfg_port              int(5) default NULL,
        grcfg_secret            varchar(255) CHARACTER SET 'utf8mb4' collate utf8mb4_general_ci default NULL,

        -- deprecated in 1.8.6  method was never used, now saved with password
        grcfg_encryption        varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        -- end deprecated
