...
CREATE TABLE if not exists gems__user_passwords (
        ...
        gup_password         varchar(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        gup_reset_key        char(64) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
