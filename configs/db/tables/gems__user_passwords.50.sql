...
CREATE TABLE if not exists gems__user_passwords (
        ...
        gup_password         varchar(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        gup_reset_key        char(64) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        gup_reset_requested  timestamp null,
        gup_reset_required   boolean not null default 0,
        gup_last_pwd_change  timestamp not null default current_timestamp,
        ...
        gup_created          timestamp not null default current_timestamp,
