...
CREATE TABLE if not exists gems__roles (
      ...
      grl_name varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
      grl_description varchar(50) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,

      grl_parents text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
      -- The grl_parents is a comma-separated list of parents for this role

      grl_privileges text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
