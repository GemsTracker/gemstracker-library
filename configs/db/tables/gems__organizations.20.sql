...
CREATE TABLE if not exists gems__organizations (
        ...
        gor_name                    varchar(50)   CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
        gor_code                    varchar(20)   CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        gor_user_class              varchar(30)   CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null default 'StaffUser',
        gor_location                varchar(255)   CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        gor_url                     varchar(127)  CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        ...
        gor_accessible_by           text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,

        gor_contact_name            varchar(50)  CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        gor_contact_email           varchar(127) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        gor_contact_sms_from        varchar(12) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        gor_mail_watcher            boolean not null default 1,
        gor_welcome                 text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci'  null,
        gor_signature               text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,

        gor_respondent_edit         varchar(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null default null,
        gor_respondent_show         varchar(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null default null,
