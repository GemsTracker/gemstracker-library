...
CREATE TABLE if not exists gems__respondent2org (
        gr2o_patient_nr         varchar(15) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,
        ...
        -- gr2o_treatment          varchar(200) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        gr2o_email              varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        gr2o_mailable           tinyint not null default 100 references gems__mail_codes (gmc_id),
        gr2o_comments           text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,

        gr2o_consent            varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null default 'Unknown'
                                references gems__consents (gco_description),
        gr2o_reception_code     varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' default 'OK' not null
