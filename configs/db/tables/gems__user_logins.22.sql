...
CREATE TABLE if not exists gems__user_logins (
        ...
        gul_login            varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
        gul_id_organization  bigint unsigned not null references gems__organizations (gor_id_organization),

        gul_user_class       varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null default 'NoLogin',
        gul_can_login        boolean not null default 0,
        gul_session_key      varchar(32) COLLATE 'utf8mb4_unicode_ci' NULL,

        gul_two_factor_key   varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null default null,
        ...
        gul_created          timestamp not null default current_timestamp,
