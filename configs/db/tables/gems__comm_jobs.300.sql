...
CREATE TABLE if not exists gems__comm_jobs (
        ...
        gcj_from_method             varchar(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
        gcj_from_fixed              varchar(254) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        ...
        gcj_fallback_method         varchar(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' default 'O',
        gcj_fallback_fixed          varchar(254) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        ...
        gcj_process_method          varchar(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,

        -- N => notmailed
        -- R => reminder
        -- B => before exporation
        -- E => reminder before expiration
        gcj_filter_mode             VARCHAR(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
