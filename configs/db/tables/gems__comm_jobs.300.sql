...
CREATE TABLE if not exists gems__comm_jobs (
        ...
        gcj_from_method             varchar(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,
        gcj_from_fixed              varchar(254) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,

        -- A Answerer
        -- O Answerer or Fallback
        -- F Fallback
        gcj_to_method               varchar(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' default 'R',
        -- O Use organization from address
        -- S Use site from address
        -- U Use gcj_id_user_as from address
        -- F Fixed gcj_fallback_fixed
        gcj_fallback_method         varchar(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' default 'O',
        gcj_fallback_fixed          varchar(254) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        ...
        gcj_process_method          varchar(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,

        -- N => notmailed
        -- R => reminder
        -- B => before exporation
        -- E => reminder before expiration
        gcj_filter_mode             VARCHAR(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,
        ...
        gcj_target_group            varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        ...
        gcj_round_description       varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        ...
        gcj_created                 timestamp not null default current_timestamp,
