...
CREATE TABLE if not exists gems__log_respondent_consents (
        ...
        glrc_consent_field      varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci'
                                not null default 'gr2o_consent',
        glrc_old_consent        varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null default null
                                references gems__consents (gco_description),
        glrc_new_consent        varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null
                                references gems__consents (gco_description),
