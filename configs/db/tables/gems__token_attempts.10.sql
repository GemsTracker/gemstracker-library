...
CREATE TABLE if not exists gems__token_attempts (
        ...
        gta_id_token        varchar(9) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci' not null,
        gta_ip_address      varchar(64) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci' not null,
