...
CREATE TABLE IF NOT EXISTS gems__respondent_relations (
        ...
        -- grr_initials_name           varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci',
        grr_first_name              varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci',
        -- grr_surname_prefix          varchar(10) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci',
        grr_last_name               varchar(50) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci',
        -- grr_partner_surname_prefix  varchar(10) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci',
        -- grr_partner_last_name       varchar(50) CHARACTER SET 'utf8mb4' COLLATE 'utf8_unicode_ci',
