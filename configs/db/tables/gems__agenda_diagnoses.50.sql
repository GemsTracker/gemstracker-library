...
CREATE TABLE if not exists gems__agenda_diagnoses (
        ...
        gad_source          varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null default 'manual',
        gad_id_in_source    varchar(40) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null default null,
        ...
        gad_created         timestamp not null default current_timestamp,
