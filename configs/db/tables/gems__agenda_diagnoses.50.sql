...
CREATE TABLE if not exists gems__agenda_diagnoses (
        ...
        gad_source          varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null default 'manual',
        gad_id_in_source    varchar(40) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null default null,
