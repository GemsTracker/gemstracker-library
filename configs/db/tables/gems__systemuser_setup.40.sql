...
CREATE TABLE if not exists gems__systemuser_setup (
        ...
        gsus_secret_key             varchar(400) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null default null,
        gsus_create_user            tinyint(4) unsigned NOT NULL DEFAULT '0',
        gsus_authentication         varchar(200) COLLATE 'utf8mb4_unicode_ci' NULL
                                        default 'Gems\\User\\Embed\\Auth\\HourKeySha256',
        gsus_deferred_user_loader   varchar(200) COLLATE 'utf8mb4_unicode_ci' NULL
