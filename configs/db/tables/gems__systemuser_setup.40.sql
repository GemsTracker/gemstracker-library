...
CREATE TABLE if not exists gems__systemuser_setup (
        ...
        gsus_secret_key             varchar(400) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null default null,
        gsus_create_user            tinyint(4) unsigned NOT NULL DEFAULT '0',
        gsus_authentication         varchar(200) COLLATE 'utf8mb4_general_ci' NULL
                                        default 'Gems\\User\\Embed\\Auth\\HourKeySha256',
        gsus_deferred_user_loader   varchar(200) COLLATE 'utf8mb4_general_ci' NULL
        ...
        gsus_redirect               varchar(200) COLLATE 'utf8mb4_general_ci' NULL
                                        default 'Gems\\User\\Embed\\Redirect\\RespondentShowPage',
        gsus_deferred_mvc_layout    varchar(200) COLLATE 'utf8mb4_general_ci' NULL default null,
        gsus_deferred_user_layout   varchar(200) COLLATE 'utf8mb4_general_ci' NULL default null,
        gsus_hide_breadcrumbs       varchar(20) COLLATE 'utf8mb4_general_ci' default '',
        ...
        gsus_created                timestamp not null default current_timestamp,
