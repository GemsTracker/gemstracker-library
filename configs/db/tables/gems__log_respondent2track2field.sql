...
CREATE TABLE if not exists gems__log_respondent2track2field (
        ...
        glrtf_id_sub                varchar(8) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci',
        glrtf_id_field              bigint not null references gems__track_fields (gtf_id_field),

        glrtf_old_value             text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        glrtf_old_value_manual      boolean not null default 0,

        glrtf_new_value             text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        glrtf_new_value_manual      boolean not null default 0,

        glrtf_created               timestamp not null default current_timestamp,
