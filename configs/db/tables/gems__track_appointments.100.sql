...
CREATE TABLE if not exists gems__track_appointments (
        ...
        gtap_field_name         varchar(200) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,
        gtap_field_code         varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        gtap_field_description  varchar(200) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        ...
        gtap_min_diff_unit      char(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null default 'D',
        gtap_max_diff_exists    boolean not null default 0,
        gtap_max_diff_length    int not null default 0,
        gtap_max_diff_unit      char(1) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null default 'D',
