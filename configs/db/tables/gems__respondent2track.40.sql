...
CREATE TABLE if not exists gems__respondent2track (
        ...
        gr2t_reception_code         varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' default 'OK' not null
                                    references gems__reception_codes (grc_id_reception_code),
        gr2t_comment                varchar(250) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
