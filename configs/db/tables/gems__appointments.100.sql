...
CREATE TABLE if not exists gems__appointments (
        ...
        gap_id_in_source      varchar(20) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' null default null,
        ...
        gap_status            varchar(2) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' not null default 'S'
        ...
        UNIQUE INDEX (gap_id_in_source, gap_id_organization),
