...
CREATE TABLE if not exists gems__tokens (
        gto_id_token            varchar(9) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' not null,
        ...
        gto_icon_file           varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        gto_round_description   varchar(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null,
        ...
        gto_result              varchar(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci',

        gto_comment             text CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null default null,
        gto_reception_code      varchar(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' default 'OK' not null
                                references gems__reception_codes (grc_id_reception_code),

        gto_return_url          varchar(250) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' null default null,
        ...
        gto_created             timestamp not null default current_timestamp,
