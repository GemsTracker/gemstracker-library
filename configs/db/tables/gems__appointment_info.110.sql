...
CREATE TABLE if not exists gems__appointment_info (
    ...
    gai_name               varchar(200) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,

    gai_id_filter          bigint unsigned not null references gems__appointment_filters (gaf_id),

    gai_type               varchar(64) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,

    -- Generic text fields so the classes can fill them as they please
    gai_field_key          varchar(64) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
    gai_field_value        varchar(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
