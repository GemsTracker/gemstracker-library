...
CREATE TABLE if not exists gems__mail_codes (
        ...
        gmc_mail_to_target          varchar(40) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
        gmc_mail_cause_target       varchar(40) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,

        gmc_code                    varchar(40) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
